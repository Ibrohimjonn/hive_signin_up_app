...
class HiveDB{
  ...
  static storeStr({required String username,required String pass})async{
...
//   Signup uchun
  static storeAccount({required String username,required String email,required String phone,required String pass})async{
