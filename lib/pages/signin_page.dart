...
import 'package:hive_signin_up_app/service/hive_service.dart';
...
class _SignInState extends State<SignIn> {
                  ...
                  children:[
                    ...
                    Container(
                      ...
                      child:ClipRRect(
                        ...
                        child:Image(
                          image:NetworkImage('https://www.sportsdaily.ru/s/image/134249.jpg'),
                          fit:BoxFit.cover,
                        ),
                      ),
                    ),
  ...
  Widget _fields({icon ,text,control,isPass}){
    return Container(
      width: double.infinity,
      decoration:BoxDecoration(
        border:Border(bottom: BorderSide(width: 1.5,color:Colors.grey.shade300,),),
      ),
      child:TextField(
        controller: control,
